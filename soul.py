...
TOKEN = '6915964339:AAE8qflBPP7o172jaAH10cYrsE-W5D5_1Do'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002293477738
CHANNEL_ID = -1002293477738
error_channel_id = -1002293477738
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/bgmi_trusted_seller76/68*", parse_mode='Markdown')
